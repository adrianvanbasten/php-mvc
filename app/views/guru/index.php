        ...
        <?php foreach ($data['guru'] as $guru) : ?>
            <li class="list-group-item d-flex flex-row justify-content-between">
                ...
                <div class="d-flex gap-2">
                    ...
                    <a href="<?= BASEURL; ?>guru/hapus/<?= $guru['id'] ?>" class="badge text-bg-danger text-decoration-none float-right" onclick="return confirm('apakah anda yakin ingin mengahapus guru yang bernama <?= $guru['nama'] ?>?')">hapus</a>
                </div>
            </li>
        <?php endforeach; ?>
    </ul>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="judulModal">Tambah Data Guru</h1>
